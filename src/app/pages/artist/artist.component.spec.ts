  ...
  it('should get all info from artist', () => {
    ...
    const responseRelated = {
      "artists" : [ {
        ...
        "genres" : [ "german metal", "german power metal", "melodic metal", "metal", "neo classical metal", "power metal", "progressive metal", "symphonic metal" ],
        ...
        "genres" : [ "christian power metal", "italian metal", "italian power metal", "melodic metal", "neo classical metal", "power metal", "progressive metal", "progressive power metal" ],
        ...
        "genres" : [ "finnish power metal", "melodic metal", "metal", "neo classical metal", "power metal", "progressive metal", "symphonic metal" ],
        ...
        "genres" : [ "german metal", "german power metal", "hard rock", "melodic metal", "metal", "neo classical metal", "power metal", "speed metal" ],
        ...
        "genres" : [ "german metal", "german power metal", "hard rock", "melodic metal", "metal", "neo classical metal", "old school thrash", "power metal", "rock", "speed metal" ],
